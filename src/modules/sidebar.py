...
class Sidebar:
    ...
    @staticmethod
    def about():
        about = st.sidebar.expander("🧠 About Docusaurus ")
        sections = [
            "#### Docusaurus is an AI chatbot with a conversational memory, designed to allow users to discuss their data in a more intuitive way. 📄",
    ...
    def show_options(self):
        with st.sidebar.expander("🛠️ Docusaurus's Tools", expanded=False):
